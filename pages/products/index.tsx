...
const ProductsPage = () => {
  ...
  const brands = data ? [...new Set(data.map(p => p.brand).filter(Boolean) as string[])] : [];
  ...
  return (
    <>
      <Head>
        <title>All Products | TinyPaws</title>
        <meta 
          name="description" 
          content="Shop our collection of premium pet products for your furry friend at TinyPaws" 
        />
      </Head>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Main Categories */}
        {!isCategoriesLoading && mainCategories.length > 0 && (
